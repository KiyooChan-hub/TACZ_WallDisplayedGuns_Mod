...
public final class WallGunRenderer implements BlockEntityRenderer<WallGunEntity> {
    ...
    @Override public void render(WallGunEntity gun, float partial, PoseStack pose, MultiBufferSource buffers, int light, int overlay) { WallBatches.enqueue(gun, light); }
